...
mixin _$ProductEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int page, int limit) getProduct,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int page, int limit)? getProduct,
...
class _$GetProductImpl with DiagnosticableTreeMixin implements _GetProduct {
  const _$GetProductImpl(this.page, this.limit);
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ProductEvent.getProduct(page: $page, limit: $limit)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'ProductEvent.getProduct'))
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return getProduct?.call(page, limit);
  }
...
abstract class _GetProduct implements ProductEvent {
  const factory _GetProduct(final int page, final int limit) = _$GetProductImpl;
...
class _$SyncProductImpl with DiagnosticableTreeMixin implements _SyncProduct {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'ProductEvent.syncProduct'));
  }
...
class _$GetLocalProductsImpl
    with DiagnosticableTreeMixin
    implements _GetLocalProducts {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
        .add(DiagnosticsProperty('type', 'ProductEvent.getLocalProducts'));
  }
